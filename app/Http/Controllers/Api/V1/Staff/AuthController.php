...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $this->debug('Login attempt (staff)', ['login' => $login]);
        $admin = null;
     ...
     * @route POST /api/v1/staff/auth/2fa/challenge
     */
     ...
     * @route POST /api/v1/staff/auth/2fa/verify
     */
    ...
    /**
     * Switch active role for the authenticated staff
     * @route POST /api/v1/staff/auth/role/switch
     */
    ...
    public function forgotPassword(Request $request)
    {
        ...
        PasswordResetToken::deleteForUser($email, 'staff');
    ...
    public function resetPassword(Request $request)
    {
        ...
        PasswordResetToken::deleteForUser($request->email, 'staff');
